...
using SalesWeb_CSharp.Models.Enums;

namespace SalesWeb_CSharp.Data
{
    public class SeedingService
    {
        private SalesWeb_CSharpContext _context;

        public SeedingService(SalesWeb_CSharpContext context)
        {
            _context = context;
        }
